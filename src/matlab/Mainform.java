...
public class Mainform extends javax.swing.JFrame {
    ...
    public void yajMatlab(int a, int b){
            try {
            ProcessBuilder pb = new ProcessBuilder("cmd", "/c", "func1 "+a+" "+b);
            pb.redirectError();
            Process p = pb.start();
    ...
    yajMatlab(a,b);// TODO add your handling code here:
